...
public class PinChange extends JFrame implements ActionListener{
    ...
    PinChange(String pinnumber){
        ...
        pintext.setBounds(165,265,180,20);
        image.add(pintext);
        
        pin=new JPasswordField();
        pin.setFont(new Font("Raleway",Font.BOLD,25));
        pin.setBounds(330,265,180,25);
        image.add(pin);
        ...
        repintext.setBounds(165,300,180,20);
        image.add(repintext);
        ...
        change.setBounds(355,375,150,23);
